...
`generate_ind_sector_var` generates a categorical variable for 22 industry sectors representing 2-digit [North American Industry Classification System (NAICS) codes](https://www.census.gov/naics/). Valid for 2017 and 2022 NAICS industries.
