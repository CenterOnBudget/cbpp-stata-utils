...
|               | 2.  Not White, not Latino                      |
+---------------+------------------------------------------------+
| 4             | 1.  White, not Latino                          |
|               | 2.  Black, not Latino                          |
|               | 3.  Latino (of any race)                       |
|               | 4.  Another race or multiple races, not Latino |
+---------------+------------------------------------------------+
| 5             | 1.  White, not Latino                          |
|               | 2.  Black, not Latino                          |
|               | 3.  Latino (of any race)                       |
|               | 4.  Asian, not Latino                          |
|               | 5.  Another race or multiple races, not Latino |
+---------------+------------------------------------------------+
...
|               | 4.  Asian, not Latino                          |
|               | 5.  AIAN, not Latino                           |
|               | 6.  Another race or multiple races, not Latino |
+---------------+------------------------------------------------+
...
|               | 5.  AIAN, not Latino                           |
|               | 6.  NHPI, not Latino                           |
|               | 7.  Another race or multiple races, not Latino |
+---------------+------------------------------------------------+
