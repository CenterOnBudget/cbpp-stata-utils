...
{syntab:Required: At least one of the following options must be specified}
    ...
    {synopt:{opt yearvar:name}}if merge is specified, the variable on which to merge the inflation data into data in memory; default is {bf:yearvar(year)}.{p_end}
