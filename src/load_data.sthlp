...
{p 4 4 2}
If {it:dataset} is ACS, the program will load the one-year merged person-household ACS files. If {it:dataset} is CPS, the program will load the merged person-family-household CPS ASEC files. Available years are 1980-2019 for CPS, 2000-2018 for ACS, and 1980-2018 for QC.
