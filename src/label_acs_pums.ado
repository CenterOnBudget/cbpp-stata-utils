...
The program automatically caches the retrived data dictionary and labels. To avoid downloading and generating the files each time, specify the _use_cache_ option. If you do not specify _use_cache_, or if you have never run __label_acs_pums__ for the year and sample specified, you must be connected to the internet to use this program.
