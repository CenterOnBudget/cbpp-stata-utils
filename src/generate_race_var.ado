...
__generate_race_var__ generates a categorial variable for race-ethnicity. It can be used with CPS or ACS microdata. Users may specify the desired number of levels: 2, 4-7 for CPS and 2, 4-8 for ACS.
